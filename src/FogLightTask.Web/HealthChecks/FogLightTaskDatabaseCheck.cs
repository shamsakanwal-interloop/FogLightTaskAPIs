...
public class FogLightTaskDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public FogLightTaskDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
