...
public class FogLightTaskDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        FogLightTaskGlobalFeatureConfigurator.Configure();
        FogLightTaskModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<FogLightTaskDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<FogLightTaskResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/FogLightTask");

            options.DefaultResourceType = typeof(FogLightTaskResource);
        ...
        {
            options.MapCodeNamespace("FogLightTask", typeof(FogLightTaskResource));
        });
    }
}
